    ...
    alert("Welcome guys")
    confirm("Masih mau lanjut kah?")
    confirm("Masih lanjut?")
    confirm("Masih lanjut???")
    confirm("yakinnn???")
    confirm("yakinnn dekkkk??")
    confirm("yakin masih mau lanjut???")
    confirm("hehee")
    confirm("okee masuk dehh")
    prompt("Welcome to website prasasti horeglitikum") 
    Date("10-10-2025"); 
    parseInt("123") 
    setTimeout(functionName, 5000)
    function foo() {alert("Welcome guys");}foo(); a